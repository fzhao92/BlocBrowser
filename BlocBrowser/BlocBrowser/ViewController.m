...
- (void)loadView {
    ...
    self.textField.placeholder = NSLocalizedString(@"Website URL or Google Search Term", @"Placeholder text for web browser URL field");
...
- (void) viewWillLayoutSubviews {
    ...
    self.awesomeToolbar.frame = CGRectMake(20, 100, 60, 280);
}
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    if ([URLString containsString:@" "]) {
        NSString *searchTerm = [URLString stringByReplacingOccurrencesOfString:@" " withString:@"+"];
        URL = [NSURL URLWithString:[NSString stringWithFormat:@"http://www.google.com/search?q=%@", searchTerm]];
    }
    else{
...
- (void) displayWelcomeMessage {
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Welcome!", @"welcome title") message:NSLocalizedString(@"Enjoy the experience", @"welcome message") preferredStyle:UIAlertControllerStyleAlert];
